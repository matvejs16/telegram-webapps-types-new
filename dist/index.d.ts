export declare namespace TelegramWebApps {
	...
	interface CloudStorage {
		...
		setItem(
			key: string,
			value: string,
			callback?: (error: Error | null, confirm: boolean) => void,
		): CloudStorage;
		/**
		 * Bot API 6.9+
		 ...
		 */
		getKeys(
			callback: (error: Error | null, keys?: Record<string, string>) => void,
		): CloudStorage;
	}
	...
	interface SecureStorage {
		...
		getItem(
			key: string,
			callback: (error: Error | null, value?: string, canRestore?: boolean) => void,
		): SecureStorage;
		/**
...
export const Telegram: TelegramWebApps.SDK;
